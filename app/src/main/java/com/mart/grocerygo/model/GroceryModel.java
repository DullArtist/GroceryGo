...
public class GroceryModel implements Serializable {
    ...
    public GroceryModel(String grocery_Name, String grocery_Image, String grocery_Category, String price_Currency, String quantity_Unit, long grocery_Price, long grocery_Quantity,String grocery_Description,String ID) {
    ...
    public long getGrocery_Quantity() {
        return Grocery_Quantity;
    }

    public void setGrocery_Quantity(long grocery_Quantity) {
        Grocery_Quantity = grocery_Quantity;
    }
